#' PKADVAN: An R-package for Simulating Pharmacokinetic Data From Various Pharmacokinetic Models.
#'
#' @description The \code{PKADVAN} is an R-package that uses the ADVAN-style analytical solutions for simulating pharmacokinetic data from various population pharmacokinetic models.
